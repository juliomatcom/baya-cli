...
| [execution.md](execution.md)       | How are tasks scheduled, made parallel, locked, isolated, failed, retried, parked, resumed, and interrupted? How do later tasks reuse what earlier ones learned (§Memory, §Session reuse)? |
