...
export const BUILTIN_CATALOG: Catalog = {
  codex: [
    ...
    },
    {
      id: 'gpt-6-astra',
      aliases: ['astra'],
      description: 'most capable: advanced reasoning, computer use, and judgment',
    },
    {
      id: 'gpt-5.5',
      aliases: [],
      description: 'previous-generation flagship for complex workflows',
    },
    {
      id: 'gpt-5.4',
      aliases: [],
      description: 'professional work; strong coding and tool use',
    },
    {
      id: 'gpt-5.4-mini',
      aliases: [],
      description: 'fast, efficient model for responsive coding tasks',
    },
    {
      id: 'gpt-5.3-codex-spark',
      aliases: ['spark'],
      description: 'text-only research preview tuned for real-time coding iteration',
    },
  ],
  claude: [
    {
      id: 'claude-fable-5-1',
      aliases: ['fable'],
      description: 'demanding reasoning and long-horizon agentic work; slower',
    },
    {
      id: 'claude-fable-5',
      aliases: ['fable-5'],
      description: 'previous-generation Fable for long-running agents; slower',
    },
    {
      id: 'claude-opus-5',
      aliases: ['opus'],
  ...
  copilot: [
    ...
    },
    {
      id: 'claude-fable-5.1',
      aliases: [],
      description: 'anthropic, demanding reasoning and long-horizon agents',
    },
    { id: 'claude-sonnet-4', aliases: [], description: 'anthropic, mid-tier balanced' },
    {
      id: 'claude-haiku-4.5',
      aliases: [],
      description: 'anthropic, lightweight and fast',
    },
    { id: 'gpt-5.3-codex', aliases: [], description: 'openai, long-term support' },
    {
      id: 'gpt-5-mini',
      aliases: [],
      description: 'openai, lightweight basic assistance',
    },
    { id: 'gpt-5.4', aliases: [], description: 'openai, strong general capability' },
    { id: 'gpt-5.4-mini', aliases: [], description: 'openai, lightweight gpt-5.4' },
    {
      id: 'gpt-5.4-nano',
      aliases: [],
      description: 'openai, smallest, resource-constrained',
    },
    ...
    { id: 'gpt-6-astra', aliases: [], description: 'openai, latest most capable' },
    { id: 'gemini-3.5-flash', aliases: [], description: 'google, lightweight' },
    { id: 'gemini-3.6-flash', aliases: [], description: 'google, balanced' },
    { id: 'gemini-3.7-flash', aliases: [], description: 'google, updated flash' },
    { id: 'gemini-3.8-flash', aliases: [], description: 'google, latest flash' },
    {
      id: 'mai-code-1-flash',
      aliases: [],
      description: 'microsoft, lightweight code model',
    },
    {
      id: 'mai-code-1.1-flash',
      aliases: [],
      description: 'microsoft, updated lightweight code model',
    },
    { id: 'grok-4.5', aliases: [], description: 'xai, versatile with context tiers' },
    { id: 'grok-4.6', aliases: [], description: 'xai, updated grok' },
    { id: 'kimi-k2.7-code', aliases: [], description: 'moonshot ai, coding-focused' },
